...
#define PPB_GRAPHICS_3D_INTERFACE "PPB_Graphics3D;1"
...
typedef struct _ppb_Graphics3D {
  bool (*IsGraphics3D)(PP_Resource resource);

  // EGL-like configuration ----------------------------------------------------
  bool (*GetConfigs)(int32_t *configs, int32_t config_size,
                     int32_t *num_config);
  ...
  PP_Resource (*CreateContext)(PP_Instance instance, int32_t config,
