...
struct PPB_URLLoader_Dev {
  ...
  // PP_URLREQUESTPROPERTY_RECORDUPLOADPROGRESS set to PP_TRUE.  Progress only
  // refers to the request body.  This data is only available if the
  // PP_URLREQUESTPROPERTY_RECORDUPLOADPROGRESS was set to PP_TRUE on the
  // URLRequestInfo.  This method returns PP_FALSE if upload progress is not
  // available.
  ...
  // returns PP_FALSE if download progress is not available.
